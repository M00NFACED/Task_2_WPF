...
namespace Task2_WPF.Models
{
    ...
    {
        public List<Models.Point> Vertices { get; set; }
        public double Area { get; }

        public Polygon(List<Models.Point> vertices) : base(CalculateCenterX(vertices), CalculateCenterY(vertices))
        {
            Vertices = vertices;
            Area = CalculateArea();
            if (Vertices.Count < 3)
        ...
        private static double CalculateCenterX(List<Models.Point> vertices)
        {
            return vertices.Average(v => v.CenterX);
        }

        private static double CalculateCenterY(List<Models.Point> vertices)
        {
        ...
        {
            List<Models.Point> sortedVertices = SortVertices(Vertices);
        ...
        private List<Models.Point> SortVertices(List<Models.Point> vertices)
        {
            int leftmostIndex = 0;
        ...
        private double Angle(Models.Point v1, Models.Point v2)
        {
